import {defineComponent, Component, markRaw, onMounted, ref, type PropType} from 'vue'
...
const Panel = defineComponent({
    ...
    setup(props) {
        ...
        const businessFunctionVersion = ref<FunctionVersion | undefined>(props.businessFunctionVersion)
